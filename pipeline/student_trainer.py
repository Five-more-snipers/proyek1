# File: pipeline/student_trainer.py (Versi Final yang Disederhanakan)
...
def _input_fn(file_pattern, tf_transform_output, batch_size=64):
    """Fungsi untuk memuat data dari file TFRecord."""
...
def run_fn(fn_args: FnArgs):
    ...
    # Simpan model tanpa signature kustom.
    # TFX akan membuat signature default yang kompatibel.
